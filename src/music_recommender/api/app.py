...
def _config_presence() -> ConfigPresence:
    return ConfigPresence(
        ...
        dynamodb_feedback_table_present=_has_value("FEEDBACK_TABLE_NAME"),
        dynamodb_playlists_table_present=_has_value("PLAYLISTS_TABLE_NAME"),
        dynamodb_sessions_table_present=_has_value("SESSIONS_TABLE_NAME"),
        dynamodb_users_table_present=_has_value("USERS_TABLE_NAME"),
        ...
        runtime_store_backend=os.getenv("RUNTIME_STORE_BACKEND", "auto"),
